...
class MoviesViewController: UIViewController, UICollectionViewDelegateFlowLayout {
    ...
    private func setupUI() {
        ...
        itemsCollectionView.register(MovieItemCell.self, forCellWithReuseIdentifier: MovieItemCell.identifier)
    ...
    private func bindViewModel() {
        ...
        viewModel.items
            ...
            .bind(to: itemsCollectionView.rx.items(cellIdentifier: MovieItemCell.identifier, cellType: MovieItemCell.self)) { [weak self] row, item, cell in
                guard let self = self else { return }
                
                APIService.shared.fetchDetails(for: .movie, id: item.id)
